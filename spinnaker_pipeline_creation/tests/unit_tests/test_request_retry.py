...
class TestRequestRetry:
    ...
    def test_make_request_based_on_input_proxy_error(self, monkeypatch):
        ...
        actual_response = request_retry.make_request_based_on_input('GET', 'some_url', 1, None)
    ...
    def test_make_request_based_on_input_with_incorrect_request_type(self):
        ...
        with pytest.raises(Exception) as exception:
            request_retry.make_request_based_on_input('INVALID', 'some_url', 1, None)
    ...
    def test_make_request_based_on_input_valid(self, monkeypatch):
        ...
        for request_type in request_types:
            ...
            actual_response = request_retry.make_request_based_on_input(request_type, 'some_url', 1, None)
    ...
    def test_make_request_based_on_input_invalid(self, monkeypatch):
        ...
        for request_type in request_types:
            ...
            actual_response = request_retry\
                .make_request_based_on_input(request_type, 'some_url', 1, None)
