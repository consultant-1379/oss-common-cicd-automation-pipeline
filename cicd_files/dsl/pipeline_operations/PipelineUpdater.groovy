...
def pipelineBeingGeneratedName = "oss-common-cicd-automation-pipeline_Pipeline_Updater"

pipelineJob(pipelineBeingGeneratedName) {
    description(commonSteps.defaultJobDescription(pipelineBeingGeneratedName,
        """The ${pipelineBeingGeneratedName} job updates the Jenkins Pipelines for the OSS Common CICD Automation Pipeline repo.""",
